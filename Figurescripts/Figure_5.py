# ----------------------------------------------------------------- #
# About script
# Figure 5: Correlation matrix + scatters + histograms
# ----------------------------------------------------------------- #
...
ax1.text(0.02, 0.98, '(b)', fontsize=13, ha='left', va='top',
         transform=ax1.transAxes)
ax2.text(0.02, 0.98, '(a)', fontsize=13, ha='left', va='top',
